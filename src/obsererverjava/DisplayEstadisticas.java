 ...
 * @author adrian
 */
public class DisplayEstadisticas implements Observer,DisplayValores{
    ...
    public void update(Observable o, Object arg) {
        ...
        float presion = values[2];
        float temp = values[0];
        float humedad = values[1];
        calcularPromedios(temp,humedad,presion);
        calcularMaximos(temp,humedad,presion);
        calcularMinimos(temp,humedad,presion);
        display(); //To change body of generated methods, choose Tools | Templates. //To change body of generated methods, choose Tools | Templates.
    }
}
